...
# PUT test
def test_update_user(test_client, test_add_user):
    # Add test user
    user = test_add_user("John", "john@test.com")
...
# DELETE test
def test_delete_user(test_client, test_add_user):
    # Add test user
    user = test_add_user("John", "john@test.com")

    # Delete user
    resp = test_client.delete(f"/users/{user.id}")
